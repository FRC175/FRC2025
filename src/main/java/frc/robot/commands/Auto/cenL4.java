...
public class cenL4 extends SequentialCommandGroup {

    public cenL4(Drive drive, Intake intake, Manipulator manipulator, Elevator elevator) {
        addCommands(
            new InstantCommand(() -> System.out.println("Started B2L4")),
